...
const etapas = [
  ...
  { data: 'Fev 2026', titulo: 'Planejamento e Preparação', desc: 'Reunião entre turmas, preparação de cronograma e remoção da estrutura antiga de tomates.', status: 'done' },
  { data: 'Mar 2026', titulo: 'Plantio, Manutenção e Site', desc: 'Preparação de baldes, plantio de coqueiros/hortaliças, manutenção da horta e reestruturação do site.', status: 'done' },
  { data: 'Abr 2026', titulo: 'Manutenção e Expansão do Site', desc: 'Manutenção contínua da horta e desenvolvimento de novas funcionalidades do site.', status: 'done' },
  { data: 'Mai 2026', titulo: 'Colheitas e Coffee Break', desc: 'Realização de colheitas das hortaliças e organização de Coffee Break.', status: 'done' },
  { data: 'Jun 2026', titulo: 'Finalização do Site e Apresentação Final', desc: 'Análise final e conclusão do chatbot de IA. Exposição e avaliação final do projeto.', status: 'upcoming' },
]
